  ...
  return (
    <section style={{display:'flex'}}>
      <ExerciseCard
        ...
        titleone={"Primero"}
        twopart={
          "Ejercicios de volteos, hacia el lado sano y al lado afecto, con el paciente acostado boca arriba, se levanta el brazo del lado al que vamos a girar, posteriormente con ayuda de una tercera persona se brinda un estímulo desde la cadera y tronco para realizar un medio giro y luego se logra un giro completo. "
        }
        titletwo={"Segundo"}
        threepart={
      ...
      <ExerciseCard
        title={'Tercera fase'}
        pathImage={undefined}
        onepart={"Una vez que el paciente ya controle de manera independiente el tronco al mantenerse sentado por sí solo, una tercera persona ayudará al paciente a ponerse de pie, para esto el paciente se apoya en el hombro de la persona que le vaya ayudar, y esta a su vez se tomará al paciente desde la cadera del lado afecto y del tronco y con un impulso se realizará la bipedestación ayudando con la rodilla de la segunda persona a estabilizar la rodilla afecta del paciente. "}
        titleone={"Primero"}
        twopart={"Una vez de pie se realizará cargas del peso corporal en ambos lados, para esto se mantendrá la misma posición anteriormente mencionada, y se llevará el paciente apoyarse sobre la pierna sana y posteriormente sobre la pierna del lado afecto. "}
        titletwo={"Segundo"}
        threepart={"Una vez que el paciente vaya controlando mejor el tronco en la bipedestación, se solicitará que se siente  y se levanta cada vez con menos apoyo del ayudante y se mantenga cada vez un poco mas de tiempo de pie. "}
        titlethree={"Tercero"}
      />
    </section>
  );
